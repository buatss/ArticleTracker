...
import static com.buatss.ArticleTracker.util.MediaSiteType.PulsHR;
...
public class PulsHRParserTest {
    ...
    public void findArticles_found() {
        ...
        try (MockedStatic<WebScraperUtils> mockedUtils = mockStatic(WebScraperUtils.class);
            ...
            doNothing().when(mockDriver).get(PulsHR.getMediaSite().getLink());
        ...
        List<Article> expected = List.of(
                new Article(null, "Title1", "https://www.pulshr.pl/article1", null, PulsHR.getMediaSite()),
                new Article(null, "Title2", "https://www.pulshr.pl/article2", null, PulsHR.getMediaSite())
        );
